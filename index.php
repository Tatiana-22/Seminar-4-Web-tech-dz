...
$info = [
    [
        'work_name' => 'Разработчик',
        'work_date' => 'Aug 2019 - May 2023',
        'work_descrip' => 'Тут описание работы разработчика Тут описание работы разработчика Тут описание работы разработчика',
    ],
    [
        'work_name' => 'Дворник',
        'work_date' => 'Sep 2020 - Dec 2021',
        'work_descrip' => 'Тут описание работы дворника Тут описание работы дворника Тут описание работы дворника',
    ],
    [
        'work_name' => 'Повар',
        'work_date' => 'Jan 2022 - Current',
        'work_descrip' => 'Тут описание работы повара Тут описание работы повара Тут описание работы повара',
    ],
];
?>
<!DOCTYPE html>
